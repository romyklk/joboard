...
class UserProfilController extends AbstractController
{
    ...
    public function delete(int $id, UserProfilRepository $userProfilRepository, EntityManagerInterface $em, TokenStorageInterface $tokenStorage, SessionInterface $session): Response
    {
        // Si l'utilisateur connecté n'est pas le propriétaire du profil, on le redirige vers son profil
        $user = $this->getUser();
        $userProfil = $userProfilRepository->find($id);
